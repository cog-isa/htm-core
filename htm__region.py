...
class Region:
    def __init__(self, region_size, column_size):
        ...
        cnt = 0
        self.ptr_to_cell = {} # указатель на клетку по её ID
        self.ok_times = 0
        self.ok = 0
        self.max_ok_times = 0
        ...
        for i in range(self.region_size):
            for j in range(self.region_size):
                ...
                for cell in current_column.cells:
                    ...
                    if active_den:
                        active_den.active = False #сбросим активность для следюущего шага
                ...
                # TODO: change OLOLO name to SMTH
                if ololo: # Если небыло ошибок в предсказании этой колонки
