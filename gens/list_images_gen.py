...
class ListImages:
    ...
    def _load_config_(self):
        try:
            f = open("htm-core\\gens\\Images\\config.txt","r")
            ...
            if (self.border>255 or self.border<0):
             ...
             self.border = 100
             print("EXCEPTION in module 'list_image_generator.py' while load config")
        # finally:
        #     f.close()
    def _load_images_(self):
        try:
            f = open("htm-core\\gens\\Images\\order.txt","r")
            for line in f:
            ...
            f.close()
             ...
             print("EXCEPTION in module 'list_image_generator.py' no order file")
        # finally:
        #     f.close()
    def _load_image_(self, file_name):
        try:
            ...
            Im = Image.open("htm-core\\gens\\Images\\" + file_name).resize((self.square_size,self.square_size))
            ...
            print("EXCEPTION in module 'list_image_generator.py' while load image '{}'".format(file_name))
    def move(self):
